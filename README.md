...
### Notes: This starts off by using the setup notebook to import and set up a database. There, statistics, en entry named "Penang Flavours" was added to the database and some entries were deleted. From setting up the database it was then used to answer a series of questions within the analysis notebook. 
